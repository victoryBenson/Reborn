...
export const GetProducts = () => {
  ...
  return (
    <div className="" id="search">
        <div className="md:bg-hero bg-hero2  bg-center relative sm:p-5 lg:h-[60vh] h-[40vh] transition-all px-3 flex flex-col justify-center items-center gap-4 bg-gradient-to- from-lightBrown to-brown ">
