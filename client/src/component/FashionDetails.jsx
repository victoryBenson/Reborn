...
export const FashionDetails = ({product}) => {
  ...
  return (
    <div className='shadow rounded-xl w-72 h-96 relative group mx-2 my-2'>
        <p className='bg-white h-2/3 flex justify-center relative overflow-hidden rounded-t-xl'>
            <div className='group-hover:flex hidden bg-ivory/30 transition-all absolute z-10 top-0 right-0 left-0 w-full h-full'>
                <p className='bottom-4 flex justify-center absolute w-full'>
                    <p className='flex '>
                        <button className='flex mx-2 items-center bg-lightBrown p-2 px-3 rounded-full text-white'>
                            <BsBagCheck/> 
                            Add to bag
                        </button>
                        <button onClick={()=> onOpenModal(_id)} className='flex mx-2 items-center bg-white rounded-full p-2'>
                            <TiArrowMaximise/>
                            Quick view
                        </button>
                        <Modal open={open} 
        ...
        <div className='p-3 fle flex-col h-full'>
            ...
            <p className='text-brown py-2'>Brand: {brand}</p>
            <p className='flex py-2'>
                <span className='pr-2 font-bold rounded flex items-center  text-lightBrown text-ivor'>
                    <TbCurrencyNaira/>
